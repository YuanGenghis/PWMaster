...
class SHA512(Hash):
    ...
    def update(self, arg):
        ...
        for offset in range(0, len(data), 128):
            ...
            for i in range(80):
                ...
                S0 = (self.rightrotate_64(a, 28) ^ self.rightrotate_64(a, 34) ^ self.rightrotate_64(a, 39)) & 0xFFFFFFFFFFFFFFFF
    ...
    def digest(self):
        ...
        return sum(self.leftshift(x, 64 * i) for i, x in enumerate(self.hash_pieces[::-1]))
